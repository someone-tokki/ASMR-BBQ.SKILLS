...
13. 更新学习库
   ...
   每完成一个作品，都要从本次翻译、模型 QC、风险扫描、可读性检查、抽听和人工修正中提炼可复用经验。无台本项目尤其要区分“已确认”和“待验证”。学习库维护规则见 `docs/learning_library_guide.md`；交付前必须做 learning self-check，确认没有把未证实内容写成全局规则。
